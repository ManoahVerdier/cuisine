...
<div class="test-right col-12 align-self-center  d-none @if($side=="left") d-md-none @else d-md-block @endif col-md-@if($col_text ?? false){{$col_text}}@else 12 @endif my-3">
    <h5 class="text-primary font-weight-bold border-bottom h3">{{$title}}</h5>
    <div class="text-center text-md-left h4">{!!$content!!}</div>
</div>
